...
const PagesDatas = [
  ...
  new Page(
    ...
    [
      {
        description:"Rappresentazione della Home del Sette e mezzo. Al centro abbiamo una serie di bottoni per eseguire le nostre azioni all'interno della partita. In rosso troviamo lo score attuale della partita, mentre nel riguardo giallo troviamo il numero totale di vittorie da parte del giocatore, a sinistra, e del computer, a destra.",
  ...
  new Page(
    ...
    [
      {
        description:"Rappresentazione della home del convertitore di valute si presenta con un design molto semplice ed intuitivo. Essa è composta da un input che ci da la possibilità di scegliere la quantità da convertire, due select che ci offrono la possibilità di scegliere il tipo di moneta ed un bottone 'coverti' per eseguire l'azione.",
      ...
      {
        description:"Rappresentazione della sezione info valute, essa si presenta con un design molto semplice. Nella parte alta abbiamo a disposizione una lista di bottoni che rappresentano i vari continenti. Essi ci porteranno alla sezione delle valute dei rispettivi continenti. Il box della descrizione è formato dal nome, una descrizione della storia ed una foto della valuta. Il tasto 'più informazioni' ci poterà alla pagina wikipedia della valuta.",
