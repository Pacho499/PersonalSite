  ...
  return (
    <div>
      ...
      <section className='mt-40 w-[90%] m-auto'>
        ...
        <div className="mt-10 border-secondary bg-pink border-4 rounded-lg p-10 text-center">
          ...
          <p className='text-2xl mt-10 text-black'>
            Questo è stato il mio pensiero quando ho deciso di lasciare la mia precedente professione di barista.
            <br />
      ...
      <section className='mt-20 w-[90%] m-auto'>
        <h1 className="text-center mb-12 text-3xl font-bold text-main">Esperienze lavorative</h1>
        <div className="w-1/3">
      ...
      {/* portfolio section */}
      <section className='mt-20 w-[90%] m-auto'>
        <h1 className="text-center mb-12 text-3xl font-bold text-main">Portfolio</h1>
        <div className="grid grid-cols-3 gap-4">
          ...
          <ProjectCard title={'Sette e mezzo'} languages={['React.js', 'Git', 'Netlify', 'Bootstrap', 'SASS']} bio={"Il progetto Sette e Mezzo è una semplice riproduzione del gioco classico di carte del sette e mezzo."}/>
