    ...
    <div className='relative h-full border-pink border-4 w-full m-2 rounded-lg p-6 bg-secondary text-black'>
      ...
      <div className='flex'>
        <Link  className='linkButton w-1/3 max-phone:w-fit' to={`/${pageData.title}`} state={{pageData}}>
          <button tabIndex={-1} className='h-[50px] max-phone:hidden'>
            Più informazioni
          </button>
        ...
        <div className='flex w-2/3'>
          <div tabIndex={0} className='linkButton ml-3 flex items-center'>
            <a tabIndex={-1} className='flex items-center' href={pageData.git} target='_blank' rel='noreferrer'>
          ...
          <div tabIndex={0} className='linkButton ml-3 flex items-center'>
            ...
            : <a tabIndex={-1} href={pageData.www} target='_blank' rel='noreferrer' className='flex items-center'>
